...
![配置全局账号](/Users/yyh/Desktop/Markdown/截图/github笔记/配置全局账号.png)
(注意引号前有空格,名字和邮箱均为github的名字和邮箱)
查看配置文件:git config -l
![查看配置文件](/Users/yyh/Desktop/Markdown/截图/github笔记/查看配置文件.png)
2.配置SSH公钥  
...
进入ssh目录:cd ~/.ssh  
查看是否已存在公钥:ls  
![查看是否已存在公钥](/Users/yyh/Desktop/Markdown/截图/github笔记/查看是否已存在公钥.png)
...
(后面出现的提示可直接回车进行无密码设置)  
![SSH无密码设置](/Users/yyh/Desktop/Markdown/截图/github笔记/SSH无密码设置.png)
生成后ls查看生成的公钥  
![查看生成的公钥](/Users/yyh/Desktop/Markdown/截图/github笔记/查看生成的公钥.png)
打开.pub文件:cat id_rsa.pub  
![打开pub文件](/Users/yyh/Desktop/Markdown/截图/github笔记/打开pub文件.png)
配置在github上:  
![配置在github上](/Users/yyh/Desktop/Markdown/截图/github笔记/配置在github上1.png)
![配置在github上](/Users/yyh/Desktop/Markdown/截图/github笔记/配置在github上2.png)
验证是否配置成功:ssh -T git@github.com  
![验证是否配置成功](/Users/yyh/Desktop/Markdown/截图/github笔记/验证是否配置成功.png)
3.推送文件到github中  
参考链接:[git的使用配置](https://www.cnblogs.com/henryw/p/10628156.html)  
进入本地文件夹:cd/users/...  
进行git初始化:git init(生成一个本地的git仓库)  
![git初始化](/Users/yyh/Desktop/Markdown/截图/github笔记/git初始化.png)
添加到本地仓库git中:git add 文件名(最好为英文不要有空格)  
查看git信息,可以看到已添加的文件:git status  
![查看已添加的文件](/Users/yyh/Desktop/Markdown/截图/github笔记/查看已添加的文件.png)
对文件进行标记,利于区分:git commit -m ‘提示符’  
![commit操作](/Users/yyh/Desktop/Markdown/截图/github笔记/commit操作.png)
查看执行过的commit操作:git log  
(如图所示,这之前执行了三次commit操作)  
![查看已commit的文件](/Users/yyh/Desktop/Markdown/截图/github笔记/查看已commit的文件.png)
关联到github账户:git remote add origin git@github.com:Xhhajgdh/JAVA.git  
推送到github仓库中:git push -u origin master  
![推送到github中](/Users/yyh/Desktop/Markdown/截图/github笔记/推送到github中.png)
4.基于主分支创建一个新的分支:git checkout -b 分支名  
![创建一个新的分支](/Users/yyh/Desktop/Markdown/截图/github笔记/创建一个新的分支.png)
(并且同时切换到two分支)  
在two分支下执行修改操作:  
![在two分支下执行修改操作](/Users/yyh/Desktop/Markdown/截图/github笔记/在two分支下执行修改操作.png)
(在two分支下执行的操作并不会合并到主分支中)  
然后将two分支执行的操作推到远端仓库中:git push -u origin two  
![将two分支执行的操作推到远端仓库中](/Users/yyh/Desktop/Markdown/截图/github笔记/将two分支执行的操作推到远端仓库中.png)
此时远端github仓库中已经存在两个分支:  
![github中的两个分支](/Users/yyh/Desktop/Markdown/截图/github笔记/github中的两个分支.png)
请求将two分支合并到主分支中:pull request按钮  
![请求合并到主分支中]](/Users/yyh/Desktop/Markdown/截图/github笔记/请求合并到主分支中.png)
