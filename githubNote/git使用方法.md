...
(后面出现的提示可直接回车进行无密码设置)  
![SSH无密码设置](./SSH无密码设置.png)
生成后ls查看生成的公钥  
![查看生成的公钥](./查看生成的公钥.png)
打开.pub文件:cat id_rsa.pub  
![打开pub文件](./打开pub文件.png)
配置在github上:  
![配置在github上](./配置在github上1.png)
![配置在github上](./配置在github上2.png)
验证是否配置成功:ssh -T git@github.com  
![验证是否配置成功](./验证是否配置成功.png)
3.推送文件到github中  
